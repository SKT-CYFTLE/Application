...
public class ViewRabbitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewrabbit);
        ...
        pagerAdapter = new RabbitPagerAdapter(this, fragments);
